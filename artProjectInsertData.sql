...
(1, 1, 'Renaissance Revival', '2026-05-01', '2026-08-31', 'Exploring Italian roots', 'Marco Rossi', 'Classic Renaissance'),
(2, 2, 'Sculpting the Soul', '2026-06-15', '2026-09-15', 'Modern sculpture journey', 'Jane Doe', 'Modern & Classical Sculpture'),
(3, 3, 'Impressionist Dreams', '2026-04-10', '2026-07-20', 'Light and color', 'Paul Durand', 'Light and Color'),
(4, 4, 'Digital Frontiers', '2026-07-01', '2026-10-01', 'Art in the age of AI', 'S. Jobs', 'Technology'),
(5, 5, 'Florence Golden Age', '2026-03-01', '2026-06-01', 'Uffizi masterworks', 'C. Medici', 'History'),
(6, 6, 'Velasquez & Friends', '2026-01-15', '2026-04-15', 'Spanish Golden Age', 'J. Goya', 'Baroque'),
(7, 7, 'Vermeer Masterpieces', '2026-02-01', '2026-05-30', 'Dutch domestic life', 'H. Van Rijn', 'Dutch Golden Age'),
(8, 8, 'Urban Rebellion', '2026-08-01', '2026-11-30', 'Street art evolution', 'Banksy', 'Modern Rebellion');
...
INSERT INTO Artworks (artwork_id, artwork_title, artwork_creationYear, artwork_type, artwork_medium, artwork_dimensions, artwork_description, artwork_price, artwork_status, artwork_tags, exhibition_id, gallery_id) VALUES
(101, 'Mona Lisa', 1503, 'Painting', 'Oil on Poplar', '77x53cm', 'Iconic portrait', 999999.99, 'exhibited', 'Renaissance', 1, 1),
(102, 'The Thinker', 1904, 'Sculpture', 'Bronze', '186cm', 'Contemplation', 50000.00, 'exhibited', 'Modern', 2, 2),
(103, 'Water Lilies', 1919, 'Painting', 'Oil on Canvas', '200x200cm', 'Nature', 12000.00, 'forSale', 'Impressionism', 3, 3),
(104, 'David', 1504, 'Sculpture', 'Marble', '517cm', 'Biblical hero', 888888.88, 'exhibited', 'Marble', 5, 5),
(105, 'Starry Night', 1889, 'Painting', 'Oil on Canvas', '73x92cm', 'Night sky vision', 75000.00, 'exhibited', 'Post-Impressionism', 3, 3),
(106, 'The Two Fridas', 1939, 'Painting', 'Oil on Canvas', '173x173cm', 'Self-portrait', 45000.00, 'exhibited', 'Surrealism', 4, 4),
(107, 'Great Wave', 1831, 'Print', 'Woodblock', '25x37cm', 'Japanese icon', 15000.00, 'exhibited', 'Japan', 8, 8),
(108, 'Melting Clocks', 1931, 'Painting', 'Oil on Canvas', '24x33cm', 'Surreal time', 60000.00, 'forSale', 'Surrealism', 4, 4),
(109, 'Girl with Balloon', 2002, 'Street Art', 'Stencil', '80x60cm', 'Symbol of hope', 25000.00, 'sold', 'Banksy', 8, 8),
(110, 'The Milkmaid', 1658, 'Painting', 'Oil on Canvas', '45x41cm', 'Domestic scene', 30000.00, 'exhibited', 'Dutch', 7, 7);
...
INSERT INTO presents (gallery_id, exhibition_id, gallery_id_1) VALUES
