...
CREATE TABLE Artworks( 
   ...
   FOREIGN KEY(exhibition_id, gallery_id) REFERENCES Exhibitions(exhibition_id, gallery_id) ON DELETE CASCADE
); 
...
CREATE TABLE presents( 
   ...
   FOREIGN KEY(gallery_id) REFERENCES Galleries(gallery_id) ON DELETE CASCADE, 
   FOREIGN KEY(exhibition_id, gallery_id_1) REFERENCES Exhibitions(exhibition_id, gallery_id) ON DELETE CASCADE
); 
